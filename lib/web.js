...
/**
   Handle any reject/other error.
   @param {express.Response} res
   @param {Error|import('./moose-storage').MooseStorageError} err
*/
function onErr(res, err) {
    ...
    else if (!err.isDuplicate() && !err.isShaded()) {
...
function Web() {
    ...
    app.get('/moose/:moose(oldest|latest|random)', (req, res) => {
    ...
    app.get('/irc/:moose(oldest|latest|random)', (req, res) => {
        getMoose(req.params.moose)
            .then(moose => {
    ...
    app.get('/img/:moose(oldest|latest|random)', (req, res) => {
        getMoose(req.params.moose)
            .then(moose => {
    ...
    app.get('/gallery/:age?', (req, res) => {
        ...
        // We force "simple" query parser, so the ts types are not valid.
        // @ts-ignore
